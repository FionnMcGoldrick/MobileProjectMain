...
export class GameService {
  ...
  getGame(): Observable<DetailsGameResult> {
    return this.httpClient.get<DetailsGameResult>("https://api.rawg.io/api/games/3498?&key=b4abdff1bda64f898a54686eb99ca861");
  }
